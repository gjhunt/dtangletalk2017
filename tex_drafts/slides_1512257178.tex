...
\begin{frame}
  ...
  \uncover<4->{
    ...
    \uncover<5->{&= \logistic_2\left(\frac{\left(\yca-\yaa\right)}{\slopehat}-\frac{\left(\ycb-\ybb\right)}{\slopehat}\right)}
    \end{aligned}
    \]\vspace{-1cm}\uncover<5->{Which is exactly our {\bf dtangle} estimator.}
  }
\end{frame}
