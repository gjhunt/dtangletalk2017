...
{\bf The general setting:} $\cK$ cell types, many reference samples of type $\crb k$, set of marker genes $\cbr G_{k}$ for each cell type. Want to estimate mixing proportions $p_{\crb 1},\ldots,p_{\crb K}$.
...
\]
there is we have a direct generalization
\[\hspace{-.85cm}
...
\section{Revisiting Chronic Lyme}

\begin{frame}
  \frametitle{Revisiting the Lyme Example}
  {\bf Gene expression measurements (RNA-seq) of white blood cells from Bouquet et al.}
