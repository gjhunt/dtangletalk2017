...
\begin{frame}
  ...
  \uncover<2->{{\bf\large (Step 2)} model GEP tech. as linear on \alert{$\log$-$\log$} scale:\\
    \begin{overprint}
      \onslide<2-3>\[\begin{aligned}\ycna &= \tna + \slope\log_2\ecna+\epscna\\\yana &= \tna + \slope\log_2\eana+\epsana\\\end{aligned}\]
      \onslide<4>\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\pa\eana+\pb\ebna\right)+\epscna\\\yana &= \tna + \slope\log_2\eana+\epsana\\\end{aligned}\]
      \onslide<5->\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\pa\eana\right)+\epscna\\\yana &= \tna + \slope\log_2\eana+\epsana\\\end{aligned}\]
    \end{overprint}
  }
