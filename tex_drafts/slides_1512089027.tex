...
\begin{frame}
  ...
  Existing methods assume \alert{linear mixing of measured expressions}:
  \[
  \ycn=\pa\yan+\pb\ybn
  \]
  ...
  dtangle models \alert{linear mixing of actual expressions} on the \alert{linear} scale. Let
  \begin{center}
    $\ecn = \text{actual expression  of gene {\cbr \n} in {\crb mixture sample}}$
    \end{center}
  (and similarly for $\ean$ and $\ebn$), then dtangle assumes
  \[
  \ecn=\pa\ean+\pb\ebn
  \]
