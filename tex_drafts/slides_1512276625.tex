...
{\bf The general setting:} $\cK$ cell types, $\nu_{\crb k}$ pure samples of type $\crb k$, set of marker genes $\cbr G_{k}$ for each cell type. Want to estimate mixing proportions $p_{\crb 1},\ldots,p_{\crb {\crb K}$.
  For the simple case we had
  \[
\widehat{p_{\crb A}} = ABC
\]
