...
\begin{frame}
  ...
  \end{enumerate}}
  \uncover<3->{
    We can fix this by re-normalizing each by their sum: \vspace{-.25cm}
    \begin{overprint}
      \onslide<4>\[
    \begin{aligned}
    ...
    \begin{aligned}
      \widehat{\pa}&=\frac{\exp_2\left(\frac{\ycna-\yana}{\slope}\right)}{\exp_2\left(\frac{\ycna-\yana}{\slopehat}\right)+\exp_2\left(\frac{\ycnb-\ybnb}{\slope}\right)}\\
      &= \boxed{\logistic_2\left(\frac{\left(\yca-\yaa\right)}{\slope}-\frac{\left(\ycb-\ybb\right)}{\slope}\right)}
    \end{aligned}
    \]
