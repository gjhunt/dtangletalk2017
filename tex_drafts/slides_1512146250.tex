...
\begin{frame}
  ...
  \uncover<5->{{\large {\bf How can we measure gene expression?}\\Gene Expressed $\rightarrow$ \alert{mRNA transcript} created}\\}
  ...
  \uncover<8->{\begin{center}
    \vspace{-.5cm}\hspace*{-1.25cm}\includegraphics[scale=.26]{pictures/measure_expr}
  \end{center}}
