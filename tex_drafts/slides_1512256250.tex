...
\begin{frame}
  While
  $\pa\approx\exp_2\left(\frac{\ycna-\yana}{\slope}\right)$ and $\pb\approx\exp_2\left(\frac{\ycnb-\ybnb}{\slope}\right)$
  they are not good estimators since they are not bounded above by 1, nor do they sum to 1. 
\end{frame}
