...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{.75\textwidth}
      ...
      \item however patients report fatigue, arthritis, muscle soreness and memory problems
      \end{enumerate}
     
          
      \begin{center}\alert{{\bf c.f. Bouquet et al: try to understand the immune response to Lyme.}}\end{center}}
    \end{column}
  \end{columns}
\end{frame}
