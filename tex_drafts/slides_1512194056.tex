...
\begin{frame}
  ...
  {\bf Solutions:}
  \begin{enumerate}
  \item {\bf{\color{blue}Regression}: regress $M$ on $R$. Somehow enforce constraints.}\\ (\citeauthor{Abbas2009,Gong2011,Lu2003,Wang2006,Qiao2012,Altboum2014,Newman2015})
  \item {\bf {\color{blue}Bayesian}: Similar to LDA. Estimate as MAP.} \\(\citeauthor{Quon2009,Qiao2012,Quon2013})
  \end{enumerate}
