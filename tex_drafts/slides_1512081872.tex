...
\begin{frame}
  ...
  We Estimate $\slope$ from Benchmark Data Sets\\
  \begin{figure}
  ...
  \end{figure}
  We find marker genes through differential expression analysis on the references.

  \alert{{\bf dtangle} isn't very sensitive to precisely either of these are done.}
\end{frame}
