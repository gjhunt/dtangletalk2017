...
\begin{frame}
  ...
  \end{enumerate}}
  \uncover<4->{
    We can fix this by re-normalizing each by their sum, and estimate $\pa$ by 
    \[
    \widehat{\pa}=\frac{\exp_2\left(\frac{\ycna-\yana}{\slopehat}\right)}{\exp_2\left(\frac{\ycna-\yana}{\slopehat}\right)+\pb\approx\exp_2\left(\frac{\ycnb-\ybnb}{\slopehat}\right)}
    \]
  }
\end{frame}
