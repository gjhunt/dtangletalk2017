...
\newcommand{\ycna}{\text{\Large $M$\hspace*{-.05cm}}_{{\cbr A}}}

\newcommand{\yanb}{\text{\Large $R$\hspace*{-.05cm}}_{{\crb A}}}
\newcommand{\ybnb}{\text{\Large $R$\hspace*{-.05cm}}_{{\crb B}}}
\newcommand{\ycnb}{\text{\Large $M$\hspace*{-.05cm}}_{{\cbr B}}}
...
\newcommand{\yaa}{\text{\Large $R$\hspace*{-.05cm}}_{\na}}
\newcommand{\ybb}{\text{\Large $R$\hspace*{-.05cm}}_{\nb}}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \uncover<4->{\item $\yaa,\yab=\log_2\left(\text{expresssion of markers $\na,\nb$ in the {\crb references}}\right)$}
  \end{enumerate}

  \uncover<5->{The {\bf dtangled} estimator of $\pa$ is}\vspace{.1cm}
    \begin{overprint}
    \onslide<5|handout:0>\[\widehat{\pa} = \logistic_2\left(\frac{\left(\yca-\ycb\right)-\left(\yaa-\ybb\right)}{\slopehat}\right)\]
    \onslide<6|handout:0>\[\widehat{\pa} = \logistic_2\left(\frac{\alert{\left(\yca-\ycb\right)}-\left(\yaa-\ybb\right)}{\slopehat}\right)\]
   \onslide<7|handout:0>\vspace{-.57cm}\[\widehat{\pa} = \logistic_2\overbrace{\left(\frac{\alert{\left(\yca-\ycb\right)}-\left(\yaa-\ybb\right)}{\slopehat}\right)}^{\text{normalized rel. abundance of $\crb A$ over $\crb B$}}\]
  \end{overprint}
