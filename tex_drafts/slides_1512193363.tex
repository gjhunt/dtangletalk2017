...
\begin{frame}
  ...
  \begin{center}
  $\overbrace{\text{mixture expressions}}^{M} = \overbrace{\text{mixture proportions}}^{P} \times \overbrace{\text{reference expressions}}^{R}$
  \end{center}
...
\begin{frame}
  ...
  {\bf Solutions:}
  \begin{enumerate}
  \item {\bf{\color{blue}Regression}: regress $M$ on $R$ so that elements of $P$ are regression coefficients. Somehow enforce constraints.}\\ (\citeauthor{Abbas2009,Gong2011,Lu2003,Wang2006,Qiao2012,Altboum2014,Newman2015})
