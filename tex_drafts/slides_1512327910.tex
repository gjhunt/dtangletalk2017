...
\begin{frame}
 ...
 \vspace*{-.5cm}
  ...
  \uncover<2->{\item {\bf Existing approach:} model and fit measured exprs. as $M=PR+E$ on \alert{linear} ({\color{blue} biologically plausible, not robust}) or \alert{$\log$} scale ({\color{blue} robust, not biologicall plausible})}
