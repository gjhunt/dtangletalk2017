...
\begin{frame}
  ...
  \begin{overprint}
    \onslide<6|handout:0>\[\widehat{\pa} = \logistic_2\left(\frac{\left(\yca-\yaa\right)}{\slopehat}-\frac{\left(\ycb-\ybb\right)}{\slopehat}\right)\]
      \onslide<7|handout:0>\vspace{-.57cm}\[\widehat{\pa} = \logistic_2\overbrace{\left(\frac{\left(\yca-\yaa\right)}{\slopehat}-\frac{\left(\ycb-\ybb\right)}{\slopehat}\right)}^{\text{\large norma. expr.{\cbr a} - norm. expr. {\cbr b}}}\]
