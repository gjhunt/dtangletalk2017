...
\begin{frame}
  ...
  \uncover<3->{
    ...
    \[
    \begin{aligned}
      \widehat{\pa}&=\frac{\exp_2\left(\frac{\ycna-\yana}{\slope}\right)}{\exp_2\left(\frac{\ycna-\yana}{\slopehat}\right)+\exp_2\left(\frac{\ycnb-\ybnb}{\slope}\right)}\\
      \begin{overprint}
        \onslide<4>{&= \boxed{\logistic_2\left(\frac{\left(\yca-\yaa\right)}{\slope}-\frac{\left(\ycb-\ybb\right)}{\slope}\right)}}
        \onslide<5->{&= \boxed{\logistic_2\left(\frac{\left(\yca-\yaa\right)}{\slopehat}-\frac{\left(\ycb-\ybb\right)}{\slopehat}\right)}}
    \end{overprint}
    \end{aligned}
    \]
  }
