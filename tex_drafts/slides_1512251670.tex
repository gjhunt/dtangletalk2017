...
\begin{frame}
  ...
  \uncover<6->{The {\bf dtangled} estimator of $\pa$ is}\vspace{.1cm}
   ...
   \onslide<8|handout:0>\vspace{-.57cm}\[\widehat{\pa} = \logistic_2\overbrace{\left(\frac{\alert{\left(\yca-\ycb\right)}-\left(\yaa-\ybb\right)}{\slopehat}\right)}^{\text{\large how much more type $\crb A$ than $\crb B$}}\]
  \end{overprint}
