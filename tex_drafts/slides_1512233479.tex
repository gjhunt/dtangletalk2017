...
\begin{frame}
  \frametitle{White Blood Cell GEPs Might Tell Us About Auto-Immunity}
             {\bf Bouquet et al:} study gene expression profiles (GEPs) of white blood cells (WBCs).
             \begin{center}\text{WBCs $\rigtharrow$ Immune Response $\overset{?}{\rightarrow}$ Chronic Lyme\end{center}
