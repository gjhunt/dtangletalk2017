...
\begin{frame}
  \frametitle{Genome = Cell's Instruction Booklet}
             \uncover<2->{{\Large Gene Is Expressed = Gene Used by Cell}\\}
             \uncover<3->{{\Large Gene Expressions = What Cells Are Doing}}

             
  \uncover<4->{{\large Gene Expressed $\rightarrow$ \alert{mRNA transcript} created}\\}
  \uncover<5->{\begin{center}
    \includegraphics[scale=.35]{pictures/mrna}
  \end{center}}
  \uncover<6->{{\bf Measuring Gene Expression = Quantifying mRNA transcripts}\\}
