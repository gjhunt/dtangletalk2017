...
\begin{frame}
  \frametitle{dtangle's approach}  
             ...
             \begin{overprint}
               \onslide<4>\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\ecna\right)+\epscna\\\yana &= \tna + \slope\log_2\left(\eana\right)+\epsana\\\end{aligned}\]}
               \onslide<5>\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\pa\eana+\pb\ebna\right)+\epscna\\\yana &= \tna + \slope\log_2\left(\eana\right)+\epsana\\\end{aligned}\]
               \onslide<6>\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\pa\eana\right)+\epscna\\\yana &= \tna + \slope\log_2\left(\eana\right)+\epsana\\\end{aligned}\]
               \onslide<7>\[\frac{\ycna-\yana}{\slope} = \log_2\left(\pa\right)+\epsilon\]
               \onslide<8->\[\exp_2\left(\frac{\ycna-\yana}{\slope}\right) \approx \pa\]
             \end{overprint}
\end{frame}
