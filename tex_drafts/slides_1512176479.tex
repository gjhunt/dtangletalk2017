...
\newcommand{\yca}{\text{\Large $M$\hspace*{-.15cm}}_{\na}}
\newcommand{\ycb}{\text{\Large $M$\hspace*{-.15cm}}_{\nb}}
...
\begin{frame}
  ...
  \uncover<4->{\item $\ycn,\yan,\ybn=\log_2$ expr. in {\crb mixture}, refs. {\crb A, B} of gene {\cbr \n}}.
  \end{enumerate}
