...
\begin{frame}
 ...
 \uncover<2->{{\bf Combining this definition with our models:}}
  ...
  \begin{overprint}
    ...
    \onslide<8| handout:1>\[\ycna = \tna + \slope\log_2\left(\pa\eana\right)+\epsilon_{\cbr a}\]
  \end{overprint}
  \begin{overprint}
    ...
    \onslide<8| handout:1>\[\ycnb = \tnb + \slope\log_2\left(\pb\ebnb\right)+\epsilon_{\cbr b}\]
  \end{overprint}
...
\begin{frame}
  ...
  \uncover<2->{{\bf\large (Step 2)} model GEP tech. as linear on \alert{$\log$-$\log$} scale:\\
    \begin{overprint}
      \onslide<2-3| handout:0>\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\ecna\right)+\epscna\\\yana &= \tna + \slope\log_2\left(\eana\right)+\epsana\\\end{aligned}\]
      \onslide<4| handout:0>\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\pa\eana+\pb\ebna\right)+\epscna\\\yana &= \tna + \slope\log_2\left(\eana\right)+\epsana\\\end{aligned}\]
      \onslide<5| handout:0>\[\begin{aligned}\ycna &= \tna + \slope\log_2\left(\pa\eana\right)+\epscna\\\yana &= \tna + \slope\log_2\left(\eana\right)+\epsana\\\end{aligned}\]
      \onslide<6| handout:0>\[\frac{\ycna-\yana}{\slope} = \log_2\left(\pa\right)+\epsilon\]
      \onslide<7-| handout:1>\[\exp_2\left(\frac{\ycna-\yana}{\slope}\right) \approx \pa\]
    \end{overprint}
  }
  \uncover<3->{{\bf\large (Step 3)} define marker genes: $\eanb=0\text{ and }\ebna=0$}
\end{frame}
